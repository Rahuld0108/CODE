<?php
  $this->assign('title',__('Add Content Image'));
  ?>
    ...
    <!-- general form elements -->
      ...
      <!-- form start -->
       <div class="row">
        ...
        <div class="col-md-8">
      <?php echo $this->Form->create($contentimages,['id' => 'mpr-add-frm']); ?>
      <div class="box-body">
        <div class="">
          <div class="row">
            <div class="col-md-12 firstrow">
              ...
              <div class="col-md-12">
                <div class="form-group">
                   <label class="fs11">Content<sup class="red">*</sup></label>
                   <?=  $this->Form->input('article_name',['label' =>false,"id"=> "article_id",'required'=>true,'class'=>'form-control','readonly','value'=>$contents->article->name]); ?>
